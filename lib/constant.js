...
(function (ChainIDType) {
    ChainIDType["RedCave"] = "RedCave";
})(ChainIDType = exports.ChainIDType || (exports.ChainIDType = {}));
var TransactionSignPrefixType;
(function (TransactionSignPrefixType) {
    TransactionSignPrefixType["ACCOUNT_SM"] = "01";
    TransactionSignPrefixType["DID_SM"] = "81";
})(TransactionSignPrefixType = exports.TransactionSignPrefixType || (exports.TransactionSignPrefixType = {}));
//SM account did 
...
// websoket not open 
exports.ERROR_CONNECTION_NOT_OPEN = '{ "error": "Please try again later" }';
