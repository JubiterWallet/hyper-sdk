...
var HyperProvider = /** @class */ (function () {
    ...
    HyperProvider.prototype.send = function (method, params) {
        ...
        var _a, _b;
        var rid = NextId++;
        if (this.reconnecting || this.ws === undefined || ((_a = this.ws) === null || _a === void 0 ? void 0 : _a.readyState) !== ((_b = this.ws) === null || _b === void 0 ? void 0 : _b.CONNECTING)) {
    ...
    HyperProvider.prototype.connected = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (this.ws != undefined && this.ws.readyState === WebSocket.CONNECTING)];
            });
        });
    };
