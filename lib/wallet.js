...
exports.verifyMnemonic = exports.genMnemonic = exports.didAddressToHex = exports.newWalletFromMnemonic = exports.newWalletFromPrivateKey = exports.HyperWallet = void 0;
...
var HyperWallet = /** @class */ (function () {
    ...
    HyperWallet.prototype.fromateSignature = function (signature, signType) {
        if (!signType || signType === constant_1.TX_SIGN_TYPE_DEFAULT_SM) {
            return signature;
        }
        var prefix;
...
exports.verifyMnemonic = verifyMnemonic;
