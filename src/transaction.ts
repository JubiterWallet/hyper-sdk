import {
    TX_OPTIONAL_FIELD_FROM,
    TX_OPTIONAL_FIELD_TO,
    TX_SIGN_TYPE_DID_SM,
    TX_SIGN_TYPE_ACCOUNT_SM,
    TX_SIGN_TYPE_DEFAULT_SM,
    TX_SIGN_TYPE_ACCOUNT_SM_PREFIX,
    TX_SIGN_TYPE_DID_SM_PREFIX,
    TX_OPTIONAL_FIELD_TYPE,
    TX_OPTIONAL_FIELD_EXTRA,
    TX_OPTIONAL_FIELD_VALUE,
    TX_OPTIONAL_FIELD_PAYLOAD,
    TX_OPTIONAL_FIELD_OP_CODE,
    TX_OPTIONAL_FIELD_EXTRA_ID_64,
    TX_OPTIONAL_FIELD_EXTRA_ID_STRING,
    TX_OPTIONAL_FIELD_SIGNATURE,
    TX_OPTIONAL_FIELD_SIMULATE,
    TX_OPTIONAL_FIELD_HASH,
    TX_OPTIONAL_FIELD_EXTRA_ID_LONG,
    TX_OPTIONAL_FIELD_UNSIGN_DATA,
    TX_OPTIONAL_FIELD_INVALID_MSG,
    TX_OPTIONAL_FIELD_TIMESTAMP,
    TX_OPTIONAL_FIELD_CONTRACT_NAME
} from "./constant";
//tansaction type 
 ...
 */
export const SIGN_SM_TYPE_MAP = {
    [TX_SIGN_TYPE_DEFAULT_SM]: { signType: TX_SIGN_TYPE_DEFAULT_SM, prefix: TX_SIGN_TYPE_DID_SM_PREFIX },
    [TX_SIGN_TYPE_ACCOUNT_SM]: { signType: TX_SIGN_TYPE_ACCOUNT_SM, prefix: TX_SIGN_TYPE_ACCOUNT_SM_PREFIX },
    [TX_SIGN_TYPE_DID_SM]: { signType: TX_SIGN_TYPE_DID_SM, prefix: "" },
};